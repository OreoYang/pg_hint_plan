...
-- Oracle mode: Disable empty string to NULL conversion for compatibility
SET ivorysql.emptystring_to_null TO false;
...
-- No. A-5-1-5
-- Oracle mode: Nested block comments not supported by Oracle parser - skip this test
-- /* /*+SeqScan(t1)*/  */
-- EXPLAIN (COSTS false) SELECT * FROM s1.t1 WHERE t1.c1 = 1;
...
-- No. A-7-3-11
-- No. A-9-2-11
-- Oracle mode: Nested block comments not supported - skip these tests
-- /*+SeqScan(/**/)*/
-- EXPLAIN (COSTS false) SELECT * FROM s1.t1 "/**/" WHERE "/**/".c1 = 1;
-- /*+SeqScan(/**//**//**/)*/
-- EXPLAIN (COSTS false) SELECT * FROM s1.t1 "/**//**//**/" WHERE "/**//**//**/".c1 = 1;
...
-- No. A-7-4-7
-- Oracle mode: Nested block comments not supported - skip this test
