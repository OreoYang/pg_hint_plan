...
-- Oracle mode: COLLATE "C" not supported, using default collation
CREATE UNIQUE INDEX p1_parent ON s1.p1 USING btree (c4 varchar_ops ASC NULLS LAST, (c1 * 2 < 100)) WHERE c1 < 10;
